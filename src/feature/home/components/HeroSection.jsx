...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full h-[500px] sm:h-[600px] lg:h-[calc(100vh-80px)] min-h-[650px] bg-white overflow-hidden">
      
      {/* LEFT CONTENT PANEL (Navy Blue with Diagonal Cut) */}
      <div 
        className="absolute inset-y-0 left-0 w-full lg:w-full bg-[#0a1f44] text-white p-6 sm:p-12 lg:p-20 xl:p-24 flex flex-col justify-between z-10 select-none
      ...
      >
        ...
        {/* Hero Text Content */}
        <div className="my-auto max-w-[90%] lg:max-w-[38%]">
          <h2 className="text-4xl sm:text-5xl lg:text-[56px] xl:text-[64px] font-normal tracking-tight leading-[1.15] mb-6 font-serif">
            {slide.titleLine1}
          ...
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-md mb-8">
            {slide.description}
          </p>
        ...
        {/* Stats Row */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-8 border-t border-white/10 max-w-[90%] lg:max-w-[36%] mb-4">
