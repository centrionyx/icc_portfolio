    ...
    <section className="w-full bg-slate-50/60 py-10 sm:py-14 px-5 lg:px-8 border-b border-slate-200/80">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-10">
          <span className="text-xs font-mono font-bold uppercase tracking-[0.2em] text-brand-accent block mb-1">
            {content.tagline}
          </span>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-[#0a1f44] tracking-tight">
            {content.titleLine1} <span className="text-brand-accent">{content.titleLine2}</span>
          </h2>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="w-10 h-10 rounded-full bg-blue-50 text-brand-accent flex items-center justify-center shadow-inner group-hover:bg-brand-accent group-hover:text-white transition-colors duration-300">
