    ...
    <section className="max-w-[1440px] mx-auto px-5 lg:px-8 py-16 sm:py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5 sm:gap-6">
        {items.map((item, idx) => (
          <div
            key={idx}
            className="relative bg-white rounded-3xl border border-slate-200/80 shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col group pt-0"
          >
