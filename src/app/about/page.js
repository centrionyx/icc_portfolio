...
export default function AboutPage() {
  ...
  return (
    <div className="w-full bg-white text-[#111827] overflow-hidden" ref={containerRef}>
      ...
      {/* LEADERSHIP — with interactive card effects */}
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-stretch">
            ...
            >
              ...
              >
                {/* Monogram hero with animated gradient */}
                <div className="relative bg-gradient-to-br from-[#003A70] to-[#005ea6] px-8 pt-10 pb-8 flex flex-col items-center text-center overflow-hidden">
                  <motion.div
                    className="absolute top-0 right-0 w-32 h-32 bg-cyan-400/10"
                    style={{ clipPath: "polygon(100% 0, 0 0, 100% 100%)" }}
                    animate={{ rotate: [0, 180, 360] }}
                    transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                  />
                  <motion.div
                    className="relative w-48 h-48 sm:w-56 sm:h-56 rounded-3xl overflow-hidden mb-6 shadow-2xl z-10 border-4 border-white/20"
                    whileHover={{ scale: 1.05 }}
                  >
                    <Image
                  ...
                  <h3 className="text-2xl font-bold text-white relative z-10">{founder.name}</h3>
                  <p className="text-xs text-cyan-300 mt-1 font-mono font-medium tracking-wider relative z-10">
                    {founder.role}
                  </p>
                  <motion.div
                    className="mt-4 w-12 h-[2px] bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full relative z-10"
                    animate={{ scaleX: [1, 1.5, 1] }}
                    transition={{ duration: 2, repeat: Infinity }}
                  />
                </div>

                <div className="px-6 py-5 flex-1 border-b border-gray-100">
                  <p className="text-sm text-[#6b7280] leading-relaxed">{founder.bio}</p>
                </div>

                <div className="grid grid-cols-2 divide-x divide-gray-100 border-b border-gray-100">
                  {[
                    { value: founder.experience || "20", suffix: "+", label: "Years Exp." },
                    { value: founder.deliveredArea || "10M", suffix: "+", label: "Sq. Ft. Delivered" }
                  ].map((item, idx) => (
                    <motion.div
                      key={idx}
                    ...
                    >
                      <motion.p
                        className="text-2xl font-black text-[#0a1f44] leading-none"
                        initial={{ scale: 1 }}
                        whileHover={{ scale: 1.2 }}
                      >
                        {item.value}
                        <span className="text-[#005ea6]">{item.suffix}</span>
                      </motion.p>
                      <p className="text-[9px] font-mono uppercase tracking-[0.18em] text-gray-400 mt-1.5">
                        {item.label}
                      </p>
                    </motion.div>
                  ))}
                ...
                >
                  <motion.div
                    className="w-8 h-8 rounded-lg bg-blue-50 border border-blue-100 flex items-center justify-center shrink-0"
                  ...
                  <a
                    href={`mailto:${founder.email}`}
                    className="text-xs font-mono text-[#003A70] hover:text-[#005ea6] transition-colors font-semibold truncate"
                  >
                    {founder.email}
                  </a>
                </motion.div>
            ...
            {/* Career Deliveries with animated bars */}
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ delay: 0.4 }}
              className="flex-1 flex flex-col rounded-2xl overflow-hidden border border-gray-200"
            >
              <div className="px-6 py-5 border-b border-gray-100 bg-white flex items-end justify-between">
                <div>
                  <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#003A70] mb-1">
                    Project Register
                  </p>
                  <h3 className="text-xl font-bold text-[#0a1f44]">Major Career Deliveries</h3>
                </div>
              ...
              <div className="grid grid-cols-[2.5rem_1fr_7rem] gap-4 px-6 py-2.5 border-b border-gray-100 bg-gray-50">
                <div className="text-[9px] font-mono uppercase tracking-[0.2em] text-gray-400">#</div>
                <div className="text-[9px] font-mono uppercase tracking-[0.2em] text-gray-400">Client</div>
                <div className="text-[9px] font-mono uppercase tracking-[0.2em] text-gray-400 text-right">
                  Area (Sq. Ft.)
                </div>
              </div>
                ...
                {careerDeliveries.map((d, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="grid grid-cols-[2.5rem_1fr_7rem] gap-4 items-center px-6 py-3.5 transition-colors group cursor-default"
                    >
                      <div className="font-mono text-[11px] font-bold text-[#003A70]/50 group-hover:text-[#003A70] transition-colors">
                        {String(idx + 1).padStart(2, "0")}
                      </div>
                      ...
                      <div className="text-right">
                        <motion.span
                          className="inline-block text-[10px] font-mono font-bold text-[#374151] group-hover:text-[#003A70] transition-colors bg-gray-50 border border-gray-200 rounded-md px-2 py-1 leading-none"
                          whileHover={{ scale: 1.1, backgroundColor: "#003A70", color: "#fff" }}
                        >
                          {d.size}
                        </motion.span>
                      </div>
              ...
              >
                ...
                <motion.span
                  className="text-sm font-black text-[#0a1f44] font-mono"
                  initial={{ scale: 1 }}
                  whileHover={{ scale: 1.1 }}
                >
                  ~24.8 <span className="text-[#005ea6]">Lakh Sq. Ft.</span>
